...
- Only port 80 is exposed by the base image
- Use a reverse proxy (Nginx, Traefik) with TLS termination in production
...
- Avoid exposing volume mounts to the host in production
